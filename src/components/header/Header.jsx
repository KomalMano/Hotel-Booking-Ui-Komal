...
const Header = ({type}) => {
  ...
  return (
    <div className='header'>
      ...
      {/* I m going to add button title description and button */}
      {
        type !== 'list' &&
        <>  
        <h1 className='headerTitle'>A lifetime of discounts? It's Genius.</h1>
      <p className='headerDesc'>Get rewarded for your travels - unlock instant savings of 10% or more with a free Komalbooking account.</p>
